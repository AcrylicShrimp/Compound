...
template<class T, std::size_t D, class EL, class ER, class Enabled = std::enable_if_t<std::is_arithmetic_v<EL>>> inline decltype(auto) operator*(EL tEL, const Compound::Math::VecOp<T, D, ER> &sVecOpR)
{
...
template<class T, std::size_t D, class EL, class ER, class Enabled = std::enable_if_t<std::is_arithmetic_v<ER>>> inline decltype(auto) operator*(const Compound::Math::VecOp<T, D, EL> &sVecOpL, ER tER)
{
